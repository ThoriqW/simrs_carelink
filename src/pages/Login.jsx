...
const Login = () => {
    return (
        <>
            <div className="min-h-screen bg-hero-pattern flex justify-center items-center">
                <div className="bg-white/50 rounded-3xl p-5">
                    ...
                    <form className="flex flex-col mt-14" action="">
                        ...
                        <input className="rounded-md px-2 h-11 w-96 mb-4" type="text" name="password" />
                        <button className="bg-button text-white p-3">Login</button>
                    </form> 
                </div>
            </div>
        </>
